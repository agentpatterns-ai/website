...
> Copilot CLI v1.0.11 discovers instructions, MCP servers, skills, and agents at each directory level up to the git root, enabling per-package monorepo configuration.
