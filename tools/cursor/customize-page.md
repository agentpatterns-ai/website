...
- AGENTS.md-first repos. Teams centralising on the [AGENTS.md open standard](https://agents.md) get a tool-specific surface back from Customize, not a cross-tool one. An AGENTS.md-first repo has already paid the consolidation cost in plain markdown a teammate can read in any editor.
