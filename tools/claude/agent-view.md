...
- Concurrency ≤ 1. A single session pays the dashboard round-trip without the scannability gain — `claude` directly is simpler ([Editor and Manager Surface Separation](../../agent-design/editor-manager-surface-separation.md)).
...
- [Editor and Manager Surface Separation in Agent IDEs](../../agent-design/editor-manager-surface-separation.md) — the cross-tool convergence this pattern is a Claude-specific instance of
