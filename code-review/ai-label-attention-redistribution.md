...
> Labeling code as LLM-generated raises reviewer fixation time +33–60% and shifts strategy toward criteria or prompt-guided review, but measured scanning thoroughness stays flat.
...
- [Reviewer's Playbook for Agent-Authored Pull Requests](reviewers-playbook-agent-authored-prs.md) — the structural inspection order this technique routes labeled PRs into
