...
- [Direct-Apply Review Comments via Cloud Agent](direct-apply-review-comments.md) — An interaction contract where a maintainer dispatches selected review comments to a cloud agent that pushes one fix commit back to the existing PR branch and re-requests review
