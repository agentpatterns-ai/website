...
- **Same-family verifier with no context reset.** Without independence, the verifier reproduces reviewer confabulations. Same model + same session = verification gate in name only.
