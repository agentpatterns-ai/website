...
The standard is tool-agnostic. The same skill folder works in Claude Code, GitHub Copilot, Cursor, Gemini CLI, and JetBrains Junie [unverified — adoption list based on agentskills.io claims, not independently verified per tool].
...
- The Agent Skills standard enables the same skill to work across multiple AI coding tools
...
- Same skill folder works in Claude Code, GitHub Copilot, Cursor, Gemini CLI, and JetBrains Junie [unverified — adoption list based on agentskills.io claims, not independently verified per tool]
