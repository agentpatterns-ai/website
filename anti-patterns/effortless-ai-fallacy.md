...
Low investment produces poor output. Poor output confirms your belief the tool doesn't work — the same misread as [perceived model degradation](perceived-model-degradation.md). That belief justifies not investing further. You never exit the loop.
