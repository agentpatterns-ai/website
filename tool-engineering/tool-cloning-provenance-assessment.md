...
- Security triage. Cloned implementations propagate vulnerabilities across the marketplace ([arxiv 2605.09817](https://arxiv.org/abs/2605.09817)). ReversingLabs found 534 of 3,984 skills on agent marketplaces contained critical vulnerabilities, including prompt injection ([ReversingLabs](https://www.reversinglabs.com/blog/how-ai-agents-upend-sscs)) — clone graphs tell a security team which downstream repos inherit a newly disclosed flaw.
