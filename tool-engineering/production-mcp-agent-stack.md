...
4. Tool grouping. Flat 1:1 API mirrors degrade at scale. [LongFuncEval (2025)](https://arxiv.org/abs/2505.10570v1) reports 7–85% selection-accuracy drops as catalogs grow. Intent-grouping ([toolset agentization](toolset-agentization.md)) shrinks the 1-of-N problem. Code-orchestration is the extreme form.
