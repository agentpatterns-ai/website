...
- **Behavioral, not procedural** — describe *what* the system should do, not *how* to implement it. The downstream executor will explore the codebase fresh, reconstructing structure at run time ([issue requirements preprocessing](../agent-design/issue-requirements-preprocessing.md)).
