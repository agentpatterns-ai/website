...
The core issue is credibility — the credible-commitment problem that [Schelling](https://www.hup.harvard.edu/books/9780674840317) named. A soft deprecation signals that the old path might persist indefinitely, which is often true. This pattern comes from the [nibzard/awesome-agentic-patterns catalog](https://github.com/nibzard/awesome-agentic-patterns/blob/main/patterns/burn-the-boats.md), which applies Thomas Schelling's credible-commitment theory from ['The Strategy of Conflict'](https://www.hup.harvard.edu/books/9780674840317) (Harvard University Press, 1960): removing retreat options makes a commitment believable to both users and the team itself.

## What this pattern looks like

A hard-deadline removal with three components:

1. Irreversible commitment — you remove the old path, rather than hide it or flag it deprecated. No opt-out period that stretches.
2. Migration path — you give users explicit alternatives and the reasons before removal, not just a notice that something is going away.
3. Hard deadline — a specific date or milestone, announced publicly, after which the old feature stops working. AMP set roughly a 60-day window.
