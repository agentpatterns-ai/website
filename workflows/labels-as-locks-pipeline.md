...
- [Issue-to-PR Delegation Pipeline](issue-to-pr-delegation-pipeline.md) — the five-phase delegation pipeline this locking discipline lets you parallelise safely
- [Continuous Triage](continuous-triage.md) — the upstream classification workflow that produces the labelled items this pattern then dispatches
