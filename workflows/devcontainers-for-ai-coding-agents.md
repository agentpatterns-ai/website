...
| Relaxed in-container permissions (e.g. `--dangerously-skip-permissions`) defensible | Claude Code reference container — the firewall + non-root user combination is what makes the claim hold ([docs](https://code.claude.com/docs/en/devcontainer)) |
