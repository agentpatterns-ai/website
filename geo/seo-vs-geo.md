...
- **Measurement opacity**: AI citation share has no standardised tracking equivalent to [Google Search Console](https://search.google.com/search-console) — campaigns may run months before lift is detectable.
