...
- ChatGPT citations closely track Bing's top-10 results, so pages that rank highly on Bing are far more likely to be cited ([Whitehat SEO](https://whitehat-seo.co.uk/blog/ai-engines-comparison-citations))
- Takes 4.8% of citations from Wikipedia, a rate no other major platform matches ([Qwairy Q3 2025](https://www.qwairy.co/blog/provider-citation-behavior-q3-2025))
...
- Routes through Brave Search: Claude citations overlap Brave's top non-sponsored results 86.7% of the time ([TechCrunch, 2025](https://techcrunch.com/2025/03/21/anthropic-appears-to-be-using-brave-to-power-web-searches-for-its-claude-chatbot/))
...
- Averages 21.87 citations per response — 2.8x more than ChatGPT ([Qwairy Q3 2025](https://www.qwairy.co/blog/provider-citation-behavior-q3-2025))
- Applies the strongest freshness weighting of any major platform, favoring recent content over older material ([Metrics Rule, 2026](https://www.metricsrule.com/research/rag-author-markup-publication-date-citations/))
...
- Draws 52.15% of citations from brand-owned websites — the highest brand preference of any platform ([Qwairy Q3 2025](https://www.qwairy.co/blog/provider-citation-behavior-q3-2025))
