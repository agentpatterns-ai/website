...
term: "Formal Process Models as Prompting Scaffolds"
...
- For open-ended reasoning or single-step tasks, simpler topologies (CoT, ToT, [Plan Mode](../tools/claude/plan-mode.md)) have lower overhead
