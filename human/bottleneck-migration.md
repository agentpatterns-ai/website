...
- [Reducing Fixed CI Overhead Before Adding Shards](../workflows/ci-setup-overhead-before-sharding.md) -- the machine-side constraint: CI capacity rather than review capacity
