...
- [Programming Language Choice Still Shapes Agent Artefacts](programming-language-choice-shapes-agent-artefacts.md) — Coding agents reach every language but the language you pick still decides performance ceiling, run cost, and verification effort — budget both
