...
- [Model-Set Parity: Reading Harness Efficiency Claims](../patterns/agent-design/model-set-parity-harness-claims.md) — the precondition a published harness figure must meet before it counts as this effect
