...
Each agent handles one work item in its own context. No state sharing between agents — this is the isolation that prevents context bleed (see [Loop Strategy Spectrum](../../loop-engineering/loop-strategy-spectrum.md)).
