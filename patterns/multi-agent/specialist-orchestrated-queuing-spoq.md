...
- Blocked precision is measured before the gate is enforcing. [Nguyen & Tran (2026)](https://arxiv.org/abs/2605.17998) report a deployed read-only verifier at 98.58% rule agreement but 0.39% blocked precision — almost every rejection a false positive. Any external dual gate inherits this risk class. Keep SPOQ's gates advisory until you measure precision.
