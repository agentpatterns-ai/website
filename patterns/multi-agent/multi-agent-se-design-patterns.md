...
!!! info "Also known as"
    Multi-Agent Architecture Patterns. Related but distinct: the [Multi-Agent Topology Taxonomy](multi-agent-topology-taxonomy.md) classifies systems at a coarser granularity — three coordination topologies (centralized, decentralized, hybrid) — while this page catalogs 16 finer-grained design patterns drawn from a 94-paper literature review.
