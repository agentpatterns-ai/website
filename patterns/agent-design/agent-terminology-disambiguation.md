...
- [Agentic Pattern Vocabulary Crosswalk](../pattern-vocabulary-crosswalk.md) — pattern-level companion: maps Ng's four, Anthropic's five, Gulli's twenty-one, and CoALA's three axes onto canonical site pages
