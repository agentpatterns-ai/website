...
> The same harness behaves differently on different backing models — treat the model as a first-class harness variable, not one generic configuration for all.
...
| Custom tool-schema strictness | Newer same-vendor releases reject off-schema fields on a custom edit tool that older releases tolerated | [Simon Willison: Armin Ronacher](https://simonwillison.net/2026/Jul/4/better-models-worse-tools/) |
