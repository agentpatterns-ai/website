...
- Contextual bias in security review. Contextual bias in LLM-based security code review is systematic and exploitable; the authors demonstrated 100% bypass success via iterative refinement attack on metadata-driven framing ([Measuring and Exploiting Contextual Bias, arxiv:2603.18740](https://arxiv.org/abs/2603.18740v2)).
