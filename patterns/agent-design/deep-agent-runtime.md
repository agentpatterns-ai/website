...
SSE delivers partial output as it materializes; a dropped connection without resume means missed events or a forced restart. Both runtimes ship SSE with `Last-Event-ID` reconnect:
