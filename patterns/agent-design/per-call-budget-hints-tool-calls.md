...
- Higher reasoning is not monotonically better. Su et al. ([2026](https://arxiv.org/abs/2604.05404v2)) report that "trajectories with higher PTE [prefill-token-equivalent] costs tend to have lower reasoning correctness." Anthropic's Sonnet 4.6 guidance agrees: set effort explicitly to avoid unexpected latency, starting from `medium` ([Anthropic effort docs](https://platform.claude.com/docs/en/build-with-claude/effort)).
