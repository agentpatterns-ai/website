...
For the autonomous-agent layer above these five workflows, see [Goal-Driven Autonomous Loop](../agent-design/goal-driven-autonomous-loop.md), [Loop Strategy Spectrum](../agent-design/loop-strategy-spectrum.md), and [Agentless vs Autonomous](../agent-design/agentless-vs-autonomous.md).
...
| **Resource-Aware Optimization** | Gulli covers cost/latency optimisation generally; the site's coverage is the cost-aware-design page plus the routing page above. | [Cost-Aware Agent Design](../agent-design/cost-aware-agent-design.md) | covered |
