...
- Supply [richer feedback than scalars](../agent-design/feedback-capability-equalizer.md) — compiler diagnostics, profiler traces, failing-test output.
...
- [Loop Strategy Spectrum](../../loop-engineering/loop-strategy-spectrum.md) — Loop structure is upstream of whether feedback can shift the agent off the prior's mode.
