...
- [Name the Check That Passed Before Accepting AI Code](../../verification/named-check-over-evaluation-confidence.md) — The human-side twin: across 506 accounts, a person's evaluation confidence tracked trust in the tool rather than the checks they ran.
...
- [Treating a Clean Static Scan as Security Evidence](static-clean-as-security-evidence.md) — The deterministic twin: a scanner's clean output is also evidence about rule coverage rather than about runtime security.
