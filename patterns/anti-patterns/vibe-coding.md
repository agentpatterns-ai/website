...
Vibe coding produces [black box nodes](trust-without-verify.md), parts of the system you do not understand. This is fine for throwaway code. It is dangerous for anything that persists:
