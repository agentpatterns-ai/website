...
Spec-driven development relocates complexity rather than removing it — planning replaces chaos, but the total work does not shrink ([Thoughtworks, 2025](https://www.thoughtworks.com/en-us/insights/blog/agile-engineering-practices/spec-driven-development-unpacking-2025-new-engineering-practices)).
