...
- [Binding an Agent's Effect to the Approval It Claims](../agent-design/interaction-effect-obligations.md) — the adjacent failure where the approval is genuine and has gone stale, closed by the same non-delegated endorsement channel.
