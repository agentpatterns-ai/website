...
- [Auditing Agent Tool Chains for Silent Partial Success](../../verification/tool-chain-silent-failure-audit.md) — the location-axis counterpart, run before deployment as a documentation differential rather than after an incident
