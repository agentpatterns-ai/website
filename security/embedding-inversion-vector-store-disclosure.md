...
|---|---|
| Input length matches inverter training length (for example, 32 tokens) | High — 92% exact match, BLEU ~83 on MSMARCO ([Morris et al., 2023](https://arxiv.org/abs/2310.06816)) |
