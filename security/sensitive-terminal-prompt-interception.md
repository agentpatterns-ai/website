...
3. **Transcript scrub.** The agent sees a sanitised stand-in for the prompt and any stdin echoes — so a downstream summariser, replay, or injected instruction cannot reconstruct what was typed.
