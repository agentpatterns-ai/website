...
A constraint that survives the trajectory satisfies four properties at once ([Li et al., 2026 §3](https://arxiv.org/abs/2605.10481)):
...
- Enforceable — built into a [deterministic runtime channel](action-selector-pattern.md) such as a gateway, hook, or sandbox, not left to model adherence to prose.
