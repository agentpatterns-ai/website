...
Inject security principles at each phase of a spec-driven workflow ([Marri, 2026](https://arxiv.org/abs/2602.02584)):
...
The constitution becomes the single source of truth for both agent prompts and automated enforcement. See [defense-in-depth agent safety](defense-in-depth-agent-safety.md) for the wider pattern of layered safety mechanisms.

## Integration with existing workflows

The constitution pattern works with instruction files already in use:

- `CLAUDE.md` and `.github/copilot-instructions.md`: reference the constitution file and add a directive to load relevant principles per task. See [hierarchical instruction files](../instructions/hierarchical-claude-md.md).
