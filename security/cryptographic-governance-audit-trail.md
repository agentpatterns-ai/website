...
- [Audit-Record Divergence as an Agent Runtime Invariant](action-audit-divergence-taxonomy.md) — companion framing of the same property as a multiset-equality invariant
