...
[Xu and Chen (2026)](https://arxiv.org/abs/2604.27464) survey autonomous agent security risks and organize them into four execution-relevant layers. The taxonomy is a navigation tool. It does not prescribe defenses; it tells you which defenses sit at which boundary.
...
The survey's core observation is that threats chain across layers. A successful injection at L1 produces an unauthorized tool call at L2. The tool writes attacker-controlled data into agent memory at L3. The next scheduled run at L4 propagates the contamination to downstream agents.
