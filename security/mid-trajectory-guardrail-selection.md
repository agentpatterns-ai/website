...
TraceSafe-Bench evaluated 13 LLM-as-a-guard models and 7 specialized guardrails across 1,000+ multi-step trajectories and 12 risk categories — security threats (prompt injection, privacy leaks, parameter manipulation) and operational failures (hallucinations, interface inconsistencies) ([TraceSafe, 2026](https://arxiv.org/abs/2604.07223v2)). Pre-execution guardrail work confirms that trajectory-level detection differs from output filtering ([Huang et al., 2025](https://arxiv.org/abs/2510.09781v1)).
