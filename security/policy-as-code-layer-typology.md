...
- [Prompt-Only Tool Access Control](../patterns/anti-patterns/prompt-only-tool-access-control.md) — The anti-pattern this typology displaces: prompt-only restrictions still let 4.0–37.0% of unauthorized calls through; architectural enforcement drives unauthorized invocation to 0%.
...
- [Adaptive Evaluation of Out-of-Band Prompt-Injection Defenses](adaptive-evaluation-out-of-band-defenses.md) — The Tool Approval stage is the deterministic out-of-band layer; this page covers the evaluation discipline for the broader class and the LLM-classifier brittleness of the other four stages.
