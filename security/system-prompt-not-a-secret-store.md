...
- [System Prompt Delivery Channels on Shared Runners](system-prompt-delivery-channel.md) — the infrastructure channel rather than the model one: what argv, the environment, and a prompt file expose to a neighboring job
