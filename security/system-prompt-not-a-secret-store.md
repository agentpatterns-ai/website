...
- Models with strong output sanitization: GPT-5's content filtering blocked ToolLeak-class extraction in independent testing ([Li et al., 2025](https://arxiv.org/abs/2509.05755), Table III); operators may keep filtering criteria in the prompt as a soft control, as long as the hard control still runs downstream.
