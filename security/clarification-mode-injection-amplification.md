...
- Two lightweight defenses (segment-level prompt guard, ask_user-aware tool filter) narrow but do not close the gap; an explicit action gate on the post-clarification turn is the architectural fix.
