...
- Execution authority, not format, is your dominant risk. A separate causal study names tool affordance as the primary driver of agent safety misalignment, reporting violation rates up to 85% once tool access is introduced ([Yu et al., 2026](https://arxiv.org/abs/2603.20320v1)). Reformatting a specification removes none of that authority.
