...
- The artifact's behavior impact is weak to begin with. Context files do not generally improve task success and add ~20% inference cost ([Gloaguen et al., 2026](https://arxiv.org/abs/2602.11988)); rearranging them within realistic sizes is compliance-neutral ([McMillan, 2026](https://arxiv.org/abs/2605.10039)). Teams catch real failures by deleting bloat, segmenting sessions, and moving hard constraints into [hooks for enforcement](../instructions/enforcing-agent-behavior-with-hooks.md).
