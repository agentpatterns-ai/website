...
- [Agent Memory Patterns: Learning Across Conversations](../patterns/agent-design/agent-memory-patterns.md) — the agent-memory systems this eval discipline measures
- [Memory Retrieval as a Control Decision](../patterns/agent-design/memory-retrieval-as-control.md) — adjacent agent-memory retrieval concern where false positives matter more than recall
