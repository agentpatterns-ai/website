...
- [Reading a Coding-Agent Vendor's Security Certificate](vendor-security-certification-scope.md) — Read the vendor's security attestation for scope before it substitutes for your own measurement
