...
- [ ] Is there a single artifact persisting across sessions ([progress files / trajectory logging](../observability/trajectory-logging-progress-files.md)) that summarizes what was tried and what was learned?
