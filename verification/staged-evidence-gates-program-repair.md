...
- Noise that survives validation: even with staged gates, layered abstention and patch-validation policies yield up to 39 percentage-point gains on human-reported bugs ([Cambronero et al., 2025](https://arxiv.org/abs/2510.03217v2)). The gates filter dominant invalid-edit classes but not all of them.
