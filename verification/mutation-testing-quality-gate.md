...
- No equivalent-mutant filter — raw mutation output runs at >50% survival rate on rigorous test suites, including at Facebook scale. [In a Facebook industrial study, only ~50% of surveyed developers said they would act on the surfaced mutants](https://arxiv.org/abs/2010.13464v3); without a classifier filtering equivalents, surfaced "gaps" are dominated by noise and developers stop acting on them.
