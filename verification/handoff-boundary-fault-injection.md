...
- Instrumenting to avoid a structural fix. A hierarchical topology showed "the lowest performance drop of 5.5%, compared to 10.5% and 23.7% of other two structures" under faulty agents, and a reviewing Inspector agent recovered "up to 96.4% errors made by faulty agents" ([Huang et al., arxiv 2408.00989v4](https://arxiv.org/abs/2408.00989v4)). Neither needs a single span. Spend the hours there first and reach for injection on the residue.
