...
- You can collect **2–10 successful traces**. The technique learns from positive examples, not failure logs alone ([GitHub Blog](https://github.blog/ai-and-ml/generative-ai/validating-agentic-behavior-when-correct-isnt-deterministic/)).
