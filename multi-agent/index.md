...
- [Verify-Gated Completion as Admission Control](verify-gated-completion-admission-control.md) — A read-only verifier separate from the producer decides whether completion claims are admitted; ambiguous cases fail closed and packetized records make every decision auditable
