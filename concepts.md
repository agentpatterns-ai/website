...
- [Action-Gated Context Trimming for Long-Horizon Agents](context-engineering/action-gated-context-trimming.md)
...
- [Claim-Scoped Invalidation for Agent Memory](context-engineering/claim-scoped-invalidation.md)
- [Comment Content as Code-Generation Context](context-engineering/comment-content-as-generation-context.md)
...
- [Gate Generation on Retrieval Sufficiency, Not Model Confidence](context-engineering/retrieval-sufficiency-gate.md)
- [Goal Recitation: Countering Drift in Long Sessions](context-engineering/goal-recitation.md)
- [Injected-Context Cost Attribution in Agent Workflows](context-engineering/injected-context-cost-attribution.md)
...
- [Mask Tools Instead of Removing Them](context-engineering/mask-tools-instead-of-removing.md)
...
- [Runtime Resource Limits as Prompt Context](context-engineering/runtime-resource-limits-as-prompt-context.md)
- [Specification Memory: What a Shared Agent Workspace Keeps](context-engineering/specification-memory-shared-workspaces.md)
- [State-Conditioned Evidence Selection for Mid-Task Retrieval](context-engineering/state-conditioned-evidence-selection.md)
- [Stage Elision Before Summarization](context-engineering/stage-elision-before-summarization.md)
- [Reproducibility Artifacts as Agent Context](context-engineering/reproducibility-artifacts-as-agent-context.md)
...
- [Constraint Preambles and the Gain Your Scanner Misses](instructions/constraint-preamble-before-generation.md)
...
- [Diagram as the Shared Spec: One Artifact for the Picture and the Prompt](instructions/diagram-as-shared-spec.md)
...
- [Frontmatter and Body Rule Drift in Agentic Workflows](instructions/frontmatter-body-rule-drift.md)
...
- [Per-Step Preconditions and Postconditions in Skill Files](instructions/per-step-skill-preconditions.md)
- [Per-Subagent Instruction Inheritance (omitClaudeMd)](instructions/per-subagent-instruction-inheritance.md)
...
- [Publishing Agent Instructions Outside the Repo (design.md)](instructions/publishing-agent-instructions-outside-the-repo.md)
- [RAMP: Committed AI Configuration and the Quality Cost](instructions/committed-ai-configuration-quality-cost.md)
- [Repairing Agent Prompts from Trace Contrast, Not Search](instructions/trace-contrast-prompt-repair.md)
...
- [Why an Encoded Rule Still Fails After a Passing Eval](instructions/encoded-rule-failure-diagnosis.md)
- [Workspace-Hosted Skills: Authorship Outside the Repo](instructions/workspace-hosted-skills.md)
- [WRAP Framework for Writing Agent-Ready Issue Descriptions](instructions/wrap-framework-agent-instructions.md)
- [Write Agent Rules You Can Grade From the Transcript](instructions/transcript-gradable-agent-rules.md)
...
- [Administrative Effort Ceilings for Reasoning Budget](patterns/agent-design/administrative-effort-ceilings.md)
...
- [Agent-Operable Interface Design (Affora)](patterns/agent-design/agent-operable-interface-design.md)
- [Artifact-Driven Workflow Compilation for Agent Execution](patterns/agent-design/artifact-driven-workflow-compilation.md)
- [Auto-Merging a Wiki Agent's Documentation Pull Requests](patterns/agent-design/auto-merged-documentation-updates.md)
- [Binding an Agent's Effect to the Approval It Claims](patterns/agent-design/interaction-effect-obligations.md)
- [Cache-Safe Routing Boundaries: Where a Router May Act](patterns/agent-design/cache-safe-routing-boundaries.md)
- [Calibrated Deciders for In-Loop Agent Decisions](patterns/agent-design/calibrated-deciders-in-loop-decisions.md)
...
- [Copilot Auto Tiers: Weighting Cost Against Quality](patterns/agent-design/copilot-auto-tier-selection.md)
...
- [Deletion and Cost Rules for an Evolving Agent Harness](patterns/agent-design/harness-deletion-and-cost-rules.md)
...
- [Deny-Fallback Permissions for Unattended Agent Runs](patterns/agent-design/deny-fallback-unattended-permissions.md)
- [Designing Agent Plugins to Survive Co-Installation](patterns/agent-design/plugin-co-installation-safety.md)
...
- [Difficulty-Aware Topology Selection for Coding Agents](patterns/agent-design/difficulty-aware-topology-selection.md)
...
- [Escalation Channels: A Reporting Tool Instead of a Reward Hack](patterns/agent-design/escalation-channels-defect-disclosure.md)
...
- [Evidence-First Reports From Failure-Diagnosis Agents](patterns/agent-design/evidence-first-diagnosis-reports.md)
...
- [Gateway Hint Headers for Routing and Budgeting Agent Calls](patterns/agent-design/gateway-hint-headers.md)
...
- [Learning Execution Guardrails from Agent Failure Traces](patterns/agent-design/trace-learned-execution-guardrails.md)
...
- [Model-Set Parity: Reading Harness Efficiency Claims](patterns/agent-design/model-set-parity-harness-claims.md)
...
- [Outcome Pricing as a Scope Signal](patterns/agent-design/outcome-pricing-as-scope-signal.md)
...
- [Path-Scoped Write Contracts for Shared Agent State](patterns/multi-agent/path-scoped-write-contracts.md)
...
- [Project-Scoped Agent Workspace: Durable Context for Clean-Context Subagents](patterns/agent-design/project-scoped-agent-workspace.md)
- [Protecting the Test Oracle From the Agent](patterns/agent-design/protect-the-oracle-from-the-agent.md)
- [Prompt-Only Baseline Before a Specialized Agent Subsystem](patterns/agent-design/prompt-only-baseline-before-specialized-subsystem.md)
...
- [Recoverability-Gated Self-Evolution for Agent Harnesses](patterns/agent-design/recoverability-gated-self-evolution.md)
- [Recurring Control Belongs in Harness Code, Not Context](patterns/agent-design/recurring-control-in-harness-code.md)
...
- [Reliability of an Automatically Selected Agent Harness](patterns/agent-design/harness-selection-reliability.md)
...
- [Residual Completion for Stateful Agent Handoffs (CFRC)](patterns/agent-design/residual-completion-stateful-handoffs.md)
- [Rerunnable Claim Graph as Shared Agent Memory](patterns/multi-agent/rerunnable-claim-graph.md)
...
- [Role-Declared Context Mode: Where the Inherit Decision Lives](patterns/multi-agent/role-declared-context-mode.md)
- [Router-Imposed Quality Ceiling: Committing Before Output](patterns/agent-design/router-imposed-quality-ceiling.md)
...
- [Running Several Coding Agents Behind One Harness Interface](patterns/agent-design/harness-adapter-layer.md)
- [Runtime Scaffold Evolution: Agents That Build Tools](patterns/agent-design/runtime-scaffold-evolution.md)
- [Runtime Workflow Selection Across Models (Project HydraFusion)](patterns/multi-agent/runtime-workflow-selection-hydrafusion.md)
- [Scope-Matched Retrieval for Persisted Agent Skills](patterns/agent-design/scope-matched-memory-retrieval.md)
...
- [Selective Revalidation for Pending Agent Actions](patterns/agent-design/selective-revalidation-pending-actions.md)
...
- [Typed Memory Provenance and Assertion Release Gating](patterns/agent-design/typed-memory-provenance-assertion-gating.md)
...
- [Choosing an Agent Tool Interface: Shell or Typed Catalog](tool-engineering/agent-tool-interface-selection.md)
...
- [Model-Switch Lifecycle Hooks: Gating a Mid-Session Model Change](tool-engineering/model-switch-lifecycle-hooks.md)
...
- [Skill or MCP Server: Choosing a Capability's Delivery Mechanism](tool-engineering/skill-or-mcp-server-delivery-selection.md)
...
- [Splitting an Agent Token Budget at the Scaling Inflection Point](token-engineering/inflection-point-session-budget-split.md)
...
- [Aggregation Bounds for Agent Authorization](security/aggregation-bounds-agent-authorization.md)
- [Always-On Agentic PR Security Review](security/always-on-pr-security-review.md)
- [An Explicit Update Boundary for Agent Self-State](security/self-state-update-boundary.md)
...
- [Benchmark Poisoning of Self-Modifying Coding Agents](security/benchmark-poisoning-self-modifying-agents.md)
- [Benign Skill Wording That Steers Package Hallucination (Neutral Prompting Attack)](security/neutral-prompting-hallucination-steering.md)
- [Bug-Class Hints as Exploit Input for Coding Agents](security/bug-class-hints-as-exploit-input.md)
- [Centrally Provisioned MCP Servers: Remote Transports Only](security/centrally-provisioned-mcp-servers.md)
- [Clarification Mode Amplifies Prompt Injection](security/clarification-mode-injection-amplification.md)
- [Closed-World Tool Call Resolution Before the Permission Gate](security/closed-world-tool-call-resolution.md)
...
- [Explanation-Bound Tool Execution for Agent Gateways](security/explanation-bound-tool-execution.md)
- [Fail-Closed Remote Settings Enforcement for Enterprise Agents](security/fail-closed-remote-settings-enforcement.md)
- [Field-Level Source Ownership for Agent Capabilities](security/field-level-source-ownership.md)
...
- [Framing Subagent Returns So They Cannot Act as Instructions](security/subagent-return-framing.md)
...
- [Local Sandboxing in the Copilot App: The Credential Axis](security/copilot-app-local-sandbox-credentials.md)
...
- [Next Edit Suggestions Carry Context You Never Curated](security/next-edit-suggestion-uncurated-context.md)
- [Non-Retirable Approval Rules for Agent Operations](security/non-retirable-approval-rules.md)
...
- [OWASP 2026 Update for Agent Builders: Top 10 Renumbering and the Agent Control Standard](security/owasp-2026-update-agent-control-standard.md)
...
- [Per-Agent Capability Stores Beat One Task-Wide Allowlist](security/per-agent-capability-scoping.md)
...
- [Proof of Presence: Re-Authenticating for Agent Actions](security/proof-of-presence-step-up-authentication.md)
...
- [Route Agent Peers by Enrolled Identity, Not Card Name](security/enrolled-identity-peer-routing.md)
...
- [System Prompt Delivery Channels on Shared Runners](security/system-prompt-delivery-channel.md)
- [Task-Based Access Control with Hybrid Inspection](security/task-based-access-control-hybrid-inspection.md)
- [The Decoding Harness Is Part of the Agent Attack Surface](security/decoding-harness-attack-surface.md)
- [The Post-Authorization Execution Trust Gap in Remote MCP](security/post-authorization-execution-trust-gap.md)
- [The Skill Closure Declaration Gap](security/skill-closure-declaration-gap.md)
...
- [Working Inside an Enterprise-Managed Agent Sandbox Policy](security/enterprise-managed-agent-sandbox.md)
...
- [Agent Approval Authority in Code Review](code-review/agent-approval-authority.md)
- [Black-Box Agent Risk Scoring by Domain](verification/black-box-agent-risk-scoring.md)
- [Agent-Resolved Review Threads](code-review/agent-resolved-review-threads.md)
- [Ambiguity Stability as a Model-Selection Criterion](verification/ambiguity-stability-model-selection.md)
- [Auditing Agent Tool Chains for Silent Partial Success](verification/tool-chain-silent-failure-audit.md)
...
- [Choosing the Judge Model That Grades Your Agent Evals](verification/judge-model-bake-off.md)
- [Claim-to-Evidence Trace Graphs for Auditing Agent Runs](verification/claim-to-evidence-trace-graphs.md)
- [Classification Before Repair in an Analyzer Backlog](verification/classification-before-repair-analyzer-backlog.md)
- [Configuring the Code Review Request Surface](code-review/review-request-surface.md)
- [Contract-Domain Tracing for Rubric Credit](verification/contract-domain-tracing-rubric-credit.md)
- [Cut-Point Replay: Test a Fix Against a Recorded Agent Run](verification/cut-point-replay-agent-regression-tests.md)
- [Detecting Self-Preference in a Single LLM Judge](verification/judge-self-preference-detection.md)
- [Enumerate Every Visible Exit Before Scoring Containment](verification/visible-exit-enumeration.md)
...
- [Explained Feedback for LLM Vulnerability Repair](verification/explained-feedback-vulnerability-repair.md)
- [False-Pass Liability Decides the Next Harness Component](verification/false-pass-liability-harness-triage.md)
- [Frozen-Base Task Mining for Repository Instruction Files](verification/frozen-base-task-mining.md)
- [Handoff-Boundary Fault Injection (llmmas-otel)](verification/handoff-boundary-fault-injection.md)
- [Hash-Pinned Command Approval for Non-Interactive Plugin Installs](verification/hash-pinned-command-approval.md)
...
- [Measure the Judge Before You Freeze a Gate on It](verification/judge-instrument-stability-check.md)
- [Measuring Synthetic Eval Data Quality (SynAE)](verification/synae-synthetic-eval-quality.md)
- [Minimum-Cost Evidence Selection for Agent Changes (Assurance Envelopes)](verification/minimum-cost-evidence-selection.md)
...
- [Name the Check That Passed Before Accepting AI Code](verification/named-check-over-evaluation-confidence.md)
...
- [Per-Attempt Sandboxes for Agents That Change the Filesystem](verification/per-attempt-eval-sandboxes.md)
- [Per-Change Deploy Monitors: Report the Verdict, Don't Act on It](verification/per-change-deploy-monitors.md)
- [Per-Layer Suppression Accounting in Acceptance Gates](verification/per-layer-suppression-accounting.md)
- [Per-Reviewer Context Views for Code Review Agents](code-review/per-reviewer-context-views.md)
...
- [Post-Merge Fix Signals for Agent Merges](verification/post-merge-fix-signals-agent-merges.md)
...
- [Pre-Execution Failure Scoring with a Draft Model (Speculative Uncertainty)](verification/speculative-uncertainty-draft-model-gate.md)
- [Pre-Generation Complexity Scoring for Code Reliability](verification/pre-generation-complexity-scoring.md)
...
- [Rank Resolution: Reading a Converged Coding-Agent Leaderboard](verification/rank-resolution-converged-leaderboards.md)
- [Reading a Coding-Agent Vendor's Security Certificate](verification/vendor-security-certification-scope.md)
- [Recover the Six Measurement Choices Behind an Attack Success Rate](verification/asr-comparability-audit.md)
- [Red-Team Your Blocking Monitor Before You Trust It](verification/red-teaming-blocking-monitors.md)
- [Rented Sandboxes for Coding-Agent Benchmark Runs](verification/rented-benchmark-sandboxes.md)
...
- [Review Constraint Tests as a Second Acceptance Gate](verification/review-constraint-acceptance-gate.md)
...
- [Route-Parity Auditing of Agent Safeguards](verification/route-parity-safeguard-auditing.md)
...
- [Task Category as the Security Review Routing Key](verification/task-category-security-review-routing.md)
...
- [Timeout Oracles for Agent-Written Code](verification/timeout-oracles-agent-written-code.md)
...
- [Trajectory-Aware Benchmark Subset Selection for Agents](verification/trajectory-aware-benchmark-subset-selection.md)
- [Transcript-Measured Review Coverage](verification/transcript-measured-review-coverage.md)
...
- [Zero Violations Is Not Evidence Your Hook Works](verification/enforcement-liveness-evidence.md)
...
- [Sizing Vendor-Emitted Agent Telemetry by Signal Tier](observability/vendor-emitted-telemetry-signal-tiers.md)
...
- [Trajectory Projection: A Flattened View of Agent Traces](observability/trajectory-projection.md)
...
- [Agent-Driven Fuzzing with Human-Gated Crash Triage](workflows/agent-driven-fuzzing-human-gated-triage.md)
...
- [Choosing the Right Surface for a Coding Agent Task](workflows/agent-surface-selection.md)
...
- [Design Docs as the Durable Artifact](workflows/design-docs-as-durable-artifact.md)
...
- [Four-Phase Agent Delegation with Curated Artifacts](workflows/four-phase-agent-delegation.md)
- [Frozen Task Sets for Affordable Agent A/B Testing](workflows/frozen-task-set-agent-ab-testing.md)
- [Humans and Agents in Software Engineering Loops](workflows/humans-agents-development-loops.md)
- [In-Place Atomic Replacement for Agent-Driven Ports](workflows/in-place-atomic-replacement-port.md)
...
- [Measuring the Verification Tax on Agent Output](workflows/verification-tax.md)
...
- [Monitor or Wait: The Supervision Choice During Agent Execution](workflows/monitor-or-wait-during-agent-execution.md)
...
- [Reducing Fixed CI Overhead Before Adding Shards](workflows/ci-setup-overhead-before-sharding.md)
- [Routing Dependency Updates to Repair Agents by Budget](workflows/dependency-update-repair-routing.md)
...
- [Sizing an Agent Migration Fan-Out by Diff Uniformity](workflows/agent-fanout-migration-diff-uniformity.md)
...
- [Trigger-to-Function Architecture for Unprompted Codebase Maintenance](workflows/trigger-function-maintenance-architecture.md)
...
- [Anonymized Customization Metrics in the Copilot CLI](human/anonymized-customization-metrics-copilot-cli.md)
...
- [Reading Copilot Feature Engagement by Its Threshold](human/copilot-feature-engagement-threshold.md)
...
- [The First Edit Predicts Whether an AI Completion Survives](human/first-edit-predicts-completion-abandonment.md)
...
- [Answer-Reachable Eval Environments](patterns/anti-patterns/answer-reachable-eval-environments.md)
...
- [Assuming Agent Interchangeability in Long-Running Teams](patterns/anti-patterns/assuming-agent-interchangeability.md)
...
- [Compound Prompt Constraints Degrade More Than Their Parts Predict](patterns/anti-patterns/compound-prompt-constraints.md)
...
- [Held-Out Tasks as a Harness Shortcut Defense](patterns/anti-patterns/held-out-tasks-as-shortcut-defense.md)
...
- [Knowledge Cutoff as a Documentation Boundary](patterns/anti-patterns/knowledge-cutoff-as-documentation-boundary.md)
...
- [Peer Refusal as a Coordination Control](patterns/anti-patterns/peer-refusal-as-coordination-control.md)
...
- [Reading Visible Edge-Case Handling as a Security Check](patterns/anti-patterns/edge-case-handling-as-security-signal.md)
...
- [Scoped-Looking Permission Grants](patterns/anti-patterns/scoped-looking-permission-grants.md)
- [Scoring Constraint Loss and Tool Reach as Separate Risks](patterns/anti-patterns/constraint-loss-and-tool-reach-scored-separately.md)
- [Serving-Stack Confounds in Tool-Call Evaluation](patterns/anti-patterns/serving-stack-confound-tool-call-evaluation.md)
...
- [Tool-Call Success as Workflow Effect Evidence](patterns/anti-patterns/tool-call-success-as-workflow-evidence.md)
- [Treating a Clean Merge as Compatibility Evidence](patterns/anti-patterns/clean-merge-as-compatibility-evidence.md)
- [Treating a Clean Static Scan as Security Evidence](patterns/anti-patterns/static-clean-as-security-evidence.md)
...
- [Separating Exposure From Selection in GEO Measurement](geo/exposure-vs-selection-geo-measurement.md)
...
- [Bounding an Embedded Copilot SDK Agent's Tool Set](tools/copilot/copilot-sdk-tool-scoping.md)
...
- [Copilot App Diff, Terminal, and Browser Panels](tools/copilot/copilot-app-diff-terminal-browser.md)
