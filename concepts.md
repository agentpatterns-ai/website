...
- [Extended Prompt Cache TTL for Long Agent Sessions](context-engineering/extended-prompt-cache-ttl.md)
- [Frontmost-Window Snapshot as Agent Context](context-engineering/frontmost-window-snapshot-context.md)
...
- [Stale Repository Retrieval Induces Incorrect Code](context-engineering/stale-repository-retrieval-induces-incorrect-code.md)
...
- [Abstention-Aware Memory Retrieval for Coding Agents](agent-design/abstention-aware-memory-retrieval.md)
...
- [Agent Self-Review Loop for Iterative Self-Improvement](agent-design/agent-self-review-loop.md)
...
- [AST-Guided Agent Memory for Repository-Level Code Generation](agent-design/ast-guided-agent-memory.md)
...
- [Cloud-Agent Tiered Model Routing: Cheap Tiers for Bounded Tasks](agent-design/cloud-agent-tiered-model-routing.md)
...
- [Code-Health-Gated LLM Tier Routing](agent-design/code-health-gated-tier-routing.md)
...
- [Component-Isolated Memory Stress Testing for LLM Agents](agent-design/component-isolated-memory-stress-testing.md)
...
- [Decentralized Memory for Self-Evolving Multi-Agent Systems](agent-design/decentralized-memory-multi-agent.md)
...
- [Memory Reinforcement Learning (MemRL)](agent-design/memory-reinforcement-learning.md)
...
- [Memory-as-Governance: Pre-Action Gates for Coding Agents](agent-design/memory-as-governance-pre-action-gate.md)
- [Meta-Engineering Harness for Production AI-Native Software Delivery](agent-design/meta-engineering-harness.md)
...
- [Prebuilt Agent Environments: Amortising Cloud Agent Cold Start with Custom Container Images](agent-design/prebuilt-agent-environments.md)
...
- [Runtime Harness Adaptation: Four-Layer Interface Fixes for Frozen LLM Agents](agent-design/runtime-harness-adaptation.md)
- [Runtime Scaffold Evolution: Agents That Build Tools](agent-design/runtime-scaffold-evolution.md)
- [Scaffold Architecture Taxonomy for Coding Agents](agent-design/scaffold-architecture-taxonomy.md)
...
- [Subprocess-per-Session Hosting Model: Four Session-Lifecycle Topology Patterns](agent-design/subprocess-per-session-hosting-model.md)
...
- [Syntax-Aware Completion Routing for Local-First Code Models](agent-design/syntax-aware-completion-routing.md)
...
- [Typed Memory from VCS History: When It Pays Off](agent-design/typed-memory-from-vcs-history.md)
...
- [Direct-Apply Review Comments via Cloud Agent](code-review/direct-apply-review-comments.md)
...
- [Held-Out Test Gap: A Long-Horizon Reward-Hacking Signal](verification/held-out-test-gap.md)
...
- [Review-Then-Apply CLI Flag for In-Process Auto-Fix](code-review/review-then-apply-cli-flag.md)
...
- [Skill Retrieval Realism Gap](verification/skill-retrieval-realism-gap.md)
...
- [Test Evolution Blind Spot in Coding Agents](verification/test-evolution-blind-spot.md)
...
- [Trajectory-Opaque Evaluation Gap: Why Final-Output Grading Misses Safety Violations](verification/trajectory-opaque-evaluation-gap.md)
