...
LogicalRAG ([Zeng et al., 2026](https://arxiv.org/abs/2605.27123)) delegates retrieval *intent* to the LLM and shrinks the backend to a faithful executor of that intent:
