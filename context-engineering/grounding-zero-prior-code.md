...
- [Gate Generation on Retrieval Sufficiency, Not Model Confidence](retrieval-sufficiency-gate.md) — the runtime half of the same problem. Identity provisioning decides what sits in context; a retrieval sufficiency gate decides whether to generate at all on this query.
