...
A reviewer asks an agent for a summary of the request path through a four-service auth flow.
...
session-store. Use arrows labeled with the call name. Stay under
15 messages.
```
