...
- [Shared Context Bundle Registry for Agent Teams](shared-context-bundle-registry.md) — A versioned, multi-consumer store of AGENTS.md, skill, and policy bundles that multiple agents pull at runtime instead of duplicating context across repos
