...
- [Per-Step Preconditions and Postconditions in Skill Files](per-step-skill-preconditions.md) — the per-step layer under the nine fields, where declared intent becomes comparable against implementation
